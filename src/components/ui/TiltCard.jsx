...
export function TiltCard({
  ...
  const sOpacity = useSpring(opacity, { stiffness: 300, damping: 20 });
  ...
  const glareBg = useMotionTemplate`radial-gradient(circle at ${gx}% ${gy}%, rgba(16, 185, 129, 0.4), transparent 25%)`;
  ...
  return (
    ...
    >
      ...
      {glare && enabled ? (
        <motion.div
          aria-hidden
          style={{ background: glareBg, opacity: sOpacity }}
